...
export default function Navigation(){
    let userProfile = JSON.parse(localStorage.getItem("blogUserProfile"))
    console.log(userProfile.fullname.slice(0, 1))
    let profileName = userProfile.fullname.slice(0, 1).toUpperCase()
